        ...
        <React.Fragment>
            <div className="container-fluid d-inline-flex">
                ...
                <div className="col-sm-4 px-5 mt-5">
                    <div className="seccion">
                        <div className="image">
                            <img src="https://dummyimage.com/600x400/f2f2f2/000000&text=QUIERO+VENDER" />
                        </div>
                        <div className="seccion-inner">
                            <div className="header text-center">
                                <h2>VENDER</h2>
                ...
                <div className="col-sm-4 px-5 mt-5">
                    <div className="seccion">
                        <div className="image">
                            <img src="https://dummyimage.com/600x400/f2f2f2/000000&text=QUIERO+CAMBIAR" />
                        </div>
                        <div className="seccion-inner">
                            <div className="header text-center">
                                <h2>INTERCAMBIAR</h2>
                                <h3>Ofrece tu producto!</h3>
                            </div>
                            <div className="content">
                                <p>Content area</p>
                            </div>
